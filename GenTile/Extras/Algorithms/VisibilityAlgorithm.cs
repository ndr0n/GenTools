...
public static class VisibilityAlgorithm
{
    ...
    /// </param>
    public static void Compute(Vector3Int origin, int rangeLimit, List<Vector3Int> fieldOfView)
    {
    ...
    static void Compute(uint octant, Vector3Int origin, int rangeLimit, uint x, Slope top, Slope bottom, List<Vector3Int> fieldOfView)
    {
    ...
    static bool BlocksLight(uint x, uint y, uint octant, Vector3Int origin)
    {
        ...
        return EntityLibrary.BlocksVision(new Vector3Int((int) nx, (int) ny, 0));
    }

    static void SetVisible(uint x, uint y, uint octant, Vector3Int origin, List<Vector3Int> fieldOfView)
    {
        uint nx = (uint) origin.x, ny = (uint) origin.y;
        switch (octant)
        {
