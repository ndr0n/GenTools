...
namespace GenTools
{
    ...
    public class TileRoom
    {
        ...
        public List<Vector3Int> PlaceWallsAndDoors(Tilegen tilegen, List<Vector3Int> availablePositions, System.Random random)
        {
            ...
            List<TileObjectType> doorsToPlace = new();
                ...
                foreach (var pos in iterPositions)
                {
                    ...
                    if (door != null)
                    {
                        if (random.Next(0, 100) < door.Chance)
                        {
                            ...
                            PlacedDoors.Add(new TileObject(door, tile, pos));
            ...
            List<TileObjectType> wallsToPlace = new();
                ...
                foreach (var pos in iterPositions)
                {
                    ...
                    if (wall != null)
                    {
                        if (random.Next(0, 100) < wall.Chance)
                        {
                            ...
                            tilemap.SetTile(pos, tile);
                            PlacedWalls.Add(new TileObject(wall, tile, pos));
        ...
        {
            List<TileObjectType> toPlace = new();
        }
                ...
                foreach (var pos in iterPositions)
                {
                    ...
                    if (obj != null)
                    {
                        if (random.Next(0, 100) < obj.Chance)
                        {
                            ...
                            tilemap.SetTile(pos, tile);
                            PlacedObjects.Add(new TileObject(obj, tile, pos));
